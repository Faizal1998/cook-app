...
function App() {
  ...
  return (
    ...
    <div className='App'>
      <SignUp setIsLoggedIn={setIsLoggedIn} displayName={displayName} setDisplayName={setDisplayName} setAccessToken={setAccessToken} />
      <SignIn setIsLoggedIn={setIsLoggedIn} displayName={displayName} setDisplayName={setDisplayName} setAccessToken={setAccessToken} />
      <Header title={"CircuitBox Blogs"} displayName={displayName} setDisplayName={setDisplayName} isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn} />
      ...
      <Routes>
        ...
        <Route path="/edit/:id" element={<EditPost
          ...
          editBody={editBody}
        />} />
        <Route path="/post/:id" element={<PostPage posts={posts} displayName={displayName} handleDelete={handleDelete} />} />
